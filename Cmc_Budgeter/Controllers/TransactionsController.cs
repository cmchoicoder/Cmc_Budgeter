...
namespace Cmc_Budgeter.Controllers
{
    public class TransactionsController : Controller
    {
        ...
        {
            var transactions = db.Transactions.Include(t => t.BankAccount).Include(t => t.BudgetItem).Include(t => t.Owner).Include(t => t.TransactionType);
        ...
        public ActionResult Create([Bind(Include = "Id,BankAccountId,BudgetItemId,TransactionTypeId,OwnerId,Memo,Amount,Created,Updated")] Transaction transaction)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,BankAccountId,BudgetItemId,TransactionTypeId,OwnerId,Memo,Amount,Created,Updated")] Transaction transaction)
        {
            if (ModelState.IsValid)
            {
